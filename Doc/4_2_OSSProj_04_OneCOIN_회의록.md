...
* 의제 목록
    * 의제 : 중간발표 피드백
* 의제별 논의 요지  
    * 의제 1 : ER 다이어그램과 블록 다이어그램 등 제작하기
* 액션 아이템
    1. 
* 공유사항 및 차기 회의 일정 : 미정
* 회의사진 :
...
* 참석자: 최해관, 송원종, 이종주
* 의제 목록
    * 의제 : DB 초기화 후 정상 작동 테스트하기
* 의제별 논의 요지  
    * 의제 1 : 실행해보고 각자 오류 찾아서 기록하기
* 액션 아이템
    1.
* 공유사항 및 차기 회의 일정 : 미정
* 회의사진 :
